...
void vertex_vertex_hessian(double a_0, double a_1, double a_2, double b_0, double b_1, double b_2, double d_h, double *out_8361029790532263509) {
   ...
   const double x15 = ((a_0) * (a_0)) - a_0*x1 + ((a_1) * (a_1)) - a_1*x13 + ((a_2) * (a_2)) - a_2*x14 + ((b_0) * (b_0)) + ((b_1) * (b_1)) + ((b_2) * (b_2));
   ...
   const double x51 = ((x17) * (x17))*x27 + x21*(-x23*x3 - x50) + x34*x48 + x37*x47 + x49;
   ...
   const double x68 = x21*(-x23*x5 - x50) + x27*((x35) * (x35)) + x49 + x52*x65 + x53*x64;
   ...
   const double x78 = x21*(-x23*x7 - x50) + x27*((x43) * (x43)) + x49 + x56*x74 + x57*x75;
   ...
   const double x84 = -x30*x82 + x38*x72 + (1.0/2.0)*x52*x57 + (1.0/2.0)*x53*x56;
