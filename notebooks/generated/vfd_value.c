...
double vfd_value(double a_0, double a_1, double a_2, double b_0, double b_1, double b_2, double c_0, double c_1, double c_2, double d_0, double d_1, double d_2) {
   ...
   vfd_value_result = (-x4*(a_2 - d_2) + x7*(a_1 - d_1) - x8*(a_0 - d_0))/sqrt(pow(x4, 2) + pow(x7, 2) + pow(x8, 2));
   return vfd_value_result;

}

void vfd_grad(double a_0, double a_1, double a_2, double b_0, double b_1, double b_2, double c_0, double c_1, double c_2, double d_0, double d_1, double d_2, double *out_1250655405979693308) {
   const double x0 = -c_1;
   ...
   out_1250655405979693308[0] = x22*(-x12 + x3 + x4*x6 + x8*x9) + x31*(-x19*x29 - x25*x26);
   out_1250655405979693308[1] = x22*(x19 + x32*x6 + x33*x8) + x31*(-x20*x29 - x26*x36);
   out_1250655405979693308[2] = x22*(-x14 + x17 - x32*x9 + x33*x4) + x31*(x25*x38 - x36*x37);
   out_1250655405979693308[3] = x22*(-x1*x8 + x39*x4) + x31*(x26*x41 - x37*x43);
   out_1250655405979693308[4] = x22*(x16*x8 + x32*x39) + x31*(-x26*x45 - x38*x43);
   out_1250655405979693308[5] = x22*(x1*x32 + x16*x4) + x31*(-x37*x45 - x38*x41);
   out_1250655405979693308[6] = x22*(x10*x8 + x2*x4) + x31*(-x26*x46 - x37*x47);
   out_1250655405979693308[7] = x22*(x2*x32 + x48*x8) + x31*(-x26*x49 - x38*x47);
   out_1250655405979693308[8] = x22*(-x10*x32 + x4*x48) + x31*(-x37*x49 + x38*x46);
...
float vfd_value(float a_0, float a_1, float a_2, float b_0, float b_1, float b_2, float c_0, float c_1, float c_2, float d_0, float d_1, float d_2) {
...
void vfd_grad(float a_0, float a_1, float a_2, float b_0, float b_1, float b_2, float c_0, float c_1, float c_2, float d_0, float d_1, float d_2, float *out_1250655405979693308) {
   const float x0 = -c_1;
