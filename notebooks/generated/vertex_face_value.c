...
void vertex_face_grad(double a_0, double a_1, double a_2, double b_0, double b_1, double b_2, double c_0, double c_1, double c_2, double d_0, double d_1, double d_2, double d_h, double *out_1164389158182881131) {
   ...
   const double x138 = (1.0/2.0)*((d_h) * (d_h)) - x103*x115 + (1.0/2.0)*x108*x118;
   ...
   out_1164389158182881131[0] = x139*(x123*(-x119 + x120 + x121 + x122) + x137*(4*a_0*b_1*c_1 + 4*a_0*b_2*c_2 - x125 - x126 - x127 - x128 + x129 + x130 + x131 + x132 - x133 - x134 - x135 - x136 - x42 - x43 + x55 + x56 + x58 + x59)) + x76*((1.0/2.0)*x105*x108*(x107 + 2*x80 + 2*x85) - x106*(x80 + x85 + x92) - x116*(-1.0/2.0*x111 - 1.0/2.0*x114) + (1.0/2.0)*x117*x118*(-x111 - x114));
   out_1164389158182881131[1] = x139*(x123*(x149 - x150 - x151 - x152) + x137*(4*a_1*b_0*c_0 + 4*a_1*b_2*c_2 - x154 - x155 - x156 - x157 + x158 + x159 - x160 - x161 - x162 - x163 - x164 + x20 + x36 - x44 + x62 + x63 + x64 + x65)) + x76*((1.0/2.0)*x105*x108*(2*x140 + 2*x142 - x143 + x144) - x106*(x100 + x140 + x142 - x99) - x116*(-1.0/2.0*x147 - 1.0/2.0*x148) + (1.0/2.0)*x117*x118*(-x147 - x148));
   out_1164389158182881131[2] = x139*(x123*(-x170 + x171 + x172 + x173) + x137*(4*a_2*b_0*c_0 + 4*a_2*b_1*c_1 - x175 - x176 - x177 - x178 + x179 + x180 + x181 - x182 - x183 - x184 - x185 - x186 - x187 + x27 + x68 + x69 + x70 + x71)) + x76*((1.0/2.0)*x105*x108*(2*x165 + 2*x166 + x167) - x106*(x165 + x166 + x98) - x116*(-1.0/2.0*x168 - 1.0/2.0*x169) + (1.0/2.0)*x117*x118*(-x168 - x169));
   out_1164389158182881131[3] = x139*(x123*(-x121 - x195 - x196 + x35) + x137*(4*a_1*b_0*c_1 + 4*a_2*b_0*c_2 + x127 + x128 - x130 - x132 + x133 + x134 - x135 + x197 + x198 + x199 + x200 - x201 - x202 - x203 - x55 - x56 - x66 - x72)) + x76*((1.0/2.0)*x105*x108*(2*x188 + 2*x190) - x106*(x188 + x190) - x116*(-1.0/2.0*x192 - 1.0/2.0*x194) + (1.0/2.0)*x117*x118*(-x192 - x194));
   out_1164389158182881131[4] = x139*(x123*(x151 - x209 + x210 + x24) + x137*(4*a_0*b_1*c_0 + 4*a_2*b_1*c_2 + x156 + x157 + x161 - x163 - x20 - x211 - x212 + x214 + x216 - x218 - x219 - x220 - x36 + x44 + x60 - x63 - x64 + x73)) + x76*((1.0/2.0)*x105*x108*(2*x204 + 2*x205) - x106*(x204 + x205) - x116*(-1.0/2.0*x207 - 1.0/2.0*x208) + (1.0/2.0)*x117*x118*(-x207 - x208));
   out_1164389158182881131[5] = x139*(x123*(-x17 - x172 + x217 - x225) + x137*(4*a_0*b_2*c_0 + 4*a_1*b_2*c_1 + x177 + x178 - x181 + x183 + x185 - x186 - x226 - x227 + x229 + x230 - x231 - x232 - x233 - x27 + x61 + x67 - x70 - x71)) + x76*((1.0/2.0)*x105*x108*(2*x221 + 2*x222) - x106*(x221 + x222) - x116*(-1.0/2.0*x223 - 1.0/2.0*x224) + (1.0/2.0)*x117*x118*(-x223 - x224));
   out_1164389158182881131[6] = x139*(x123*(x119 - x120 + x196 + x240) + x137*(4*a_1*b_1*c_0 + 4*a_2*b_2*c_0 + x125 + x126 - x129 - x131 - x136 - x197 - x198 - x199 - x200 + x201 + x202 - x203 + x42 + x43 - x58 - x59 + x66 + x72)) + x76*((1.0/2.0)*x105*x108*(2*x234 + 2*x235) - x106*(x234 + x235) - x116*(-1.0/2.0*x237 - 1.0/2.0*x239) + (1.0/2.0)*x117*x118*(-x237 - x239));
   out_1164389158182881131[7] = x139*(x123*(-x149 + x150 - x210 - x247) + x137*(4*a_0*b_0*c_1 + 4*a_2*b_2*c_1 + x154 + x155 - x158 - x159 + x160 + x162 - x164 + x211 + x212 - x214 - x216 + x218 + x219 - x220 - x60 - x62 - x65 - x73)) + x76*((1.0/2.0)*x105*x108*(2*x242 + 2*x243) - x106*(x242 + x243) - x116*(-1.0/2.0*x245 - 1.0/2.0*x246) + (1.0/2.0)*x117*x118*(-x245 - x246));
   out_1164389158182881131[8] = x139*(x123*(x170 - x171 + x225 + x252) + x137*(4*a_0*b_0*c_2 + 4*a_1*b_1*c_2 + x175 + x176 - x179 - x180 + x182 + x184 - x187 + x226 + x227 - x229 - x230 + x231 + x232 - x233 - x61 - x67 - x68 - x69)) + x76*((1.0/2.0)*x105*x108*(2*x248 + 2*x249) - x106*(x248 + x249) - x116*(-1.0/2.0*x250 - 1.0/2.0*x251) + (1.0/2.0)*x117*x118*(-x250 - x251));
   out_1164389158182881131[9] = x253*(-x122 + x195 - x240 - x35) + x76*(-1.0/2.0*x105*x107*x108 + x106*x92);
   out_1164389158182881131[10] = x253*(x152 + x209 - x24 + x247) + x76*(-x101*x106 + (1.0/2.0)*x105*x108*(x143 - x144));
   out_1164389158182881131[11] = x253*(x17 - x173 - x217 - x252) + x76*(-1.0/2.0*x105*x108*x167 + x106*x98);
