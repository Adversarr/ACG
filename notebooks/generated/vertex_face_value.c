...
double vertex_face_value(double a_0, double a_1, double a_2, double b_0, double b_1, double b_2, double c_0, double c_1, double c_2, double d_0, double d_1, double d_2, double d_h) {
   ...
   vertex_face_value_result = (-2*log(d_h) + log(((a_0*x13 - a_0*x20 + a_1*x16 - a_1*x21 + a_2*x19 - a_2*x22 - b_0*x13 + b_0*x20 - b_1*x16 + b_1*x21 - b_2*x19 + b_2*x22 + c_0*x15 - c_0*x18 - c_1*x12 + c_1*x17 + c_2*x11 - c_2*x14 - d_0*x15 + d_0*x18 + d_1*x12 - d_1*x17 - d_2*x11 + d_2*x14) * (a_0*x13 - a_0*x20 + a_1*x16 - a_1*x21 + a_2*x19 - a_2*x22 - b_0*x13 + b_0*x20 - b_1*x16 + b_1*x21 - b_2*x19 + b_2*x22 + c_0*x15 - c_0*x18 - c_1*x12 + c_1*x17 + c_2*x11 - c_2*x14 - d_0*x15 + d_0*x18 + d_1*x12 - d_1*x17 - d_2*x11 + d_2*x14))/(-a_1*c_1*x27 + b_0*x32 + b_0*x33 + b_1*x14*x37 + b_1*x38 + b_2*x17*x37 + b_2*x18*x39 + c_0*x11*x26 + c_0*x12*x30 + c_0*x32 + c_0*x33 + c_1*x15*x30 + c_1*x38 - x14*x23 - x17*x28 - x18*x34 + x24*x25 + x24*x29 + x25*x37 + x26*x35 - x27*x31 - x27*x45 - x27*x46 + x29*x37 - x31*x36 + x35*x39 - x36*x46 - x36*x50 - x40*x42 - 2*x40*x43 - x40*x54 - x40*x59 - x41*x56 - x41*x59 - x42*x43 - x43*x54 - x43*x56 + x44*x45 + x44*x46 + x44*x47 + x44*x48 + x45*x48 + x45*x51 + x45*x52 - x45*x57 + x46*x47 + x46*x49 + x46*x51 + x47*x50 + x47*x52 - x47*x53 - x47*x58 + x48*x49 + x48*x50 - x48*x53 - x48*x55 + x49*x50 + x49*x51 + x50*x52 - x50*x57 + x51*x52 - x51*x55 - x51*x58)))*((1.0/2.0)*((d_h) * (d_h)) + d_h*x10/sqrt(x9) + (1.0/2.0)*((x10) * (x10))/x9);
   return vertex_face_value_result;

}

void vertex_face_grad(double a_0, double a_1, double a_2, double b_0, double b_1, double b_2, double c_0, double c_1, double c_2, double d_0, double d_1, double d_2, double d_h, double *out_6543693310212660619) {
   ...
   const double x74 = a_0*x19 + a_0*x26 - a_0*x55 - a_0*x56 - a_0*x58 - a_0*x59 - a_1*x20 + a_1*x34 - a_1*x36 - a_1*x62 - a_1*x63 - a_1*x64 - a_1*x65 - a_2*x27 - a_2*x68 - a_2*x69 - a_2*x70 - a_2*x71 - b_1*x44 - b_1*x60 - b_1*x73 - b_2*x61 - b_2*x67 + c_0*x37 + c_0*x39 - c_0*x42 - c_0*x43 - c_0*x66 - c_0*x72 + c_2*x38 + x0*x28 + x0*x30 + x1*x29 + x1*x31 - x15*x3 + x17*x3 + x18*x3 - x22*x6 + x24*x6 + x25*x6 - x32*x4 + x33*x4 + x35*x4 + x40*x7 + x41*x7 + x45*x46 + x45*x47 + x45*x48 + x45*x49 + x46*x49 + x46*x52 + x46*x53 + x47*x48 + x47*x50 + x47*x52 + x48*x51 + x48*x53 + x49*x50 + x49*x51 + x50*x51 + x50*x52 + x51*x53 + x52*x53;
   ...
   const double x138 = (1.0/2.0)*((d_h) * (d_h)) - x101*x115 + (1.0/2.0)*x106*x118;
   ...
   out_6543693310212660619[0] = x139*(x123*(-x119 + x120 + x121 + x122) + x137*(4*a_0*b_1*c_1 + 4*a_0*b_2*c_2 - x125 - x126 - x127 - x128 + x129 + x130 + x131 + x132 - x133 - x134 - x135 - x136 - x42 - x43 + x55 + x56 + x58 + x59)) + x76*(-x101*(x80 + x81*x83 + x85*x86 - x89) + (1.0/2.0)*x106*x108*(x102*x86 + x103*x104 + x105) - x116*(-1.0/2.0*x111 - 1.0/2.0*x114) + (1.0/2.0)*x117*x118*(-x111 - x114));
   out_6543693310212660619[1] = x139*(x123*(x148 - x149 - x150 - x151) + x137*(4*a_1*b_0*c_0 + 4*a_1*b_2*c_2 - x153 - x154 - x155 - x156 + x157 + x158 - x159 - x160 - x161 - x162 - x163 + x20 + x36 - x44 + x62 + x63 + x64 + x65)) + x76*(-x101*(x140*x83 + x141*x85 + x98) + (1.0/2.0)*x106*x108*(x102*x141 + x104*x107 - x142 + x143) - x116*(-1.0/2.0*x146 - 1.0/2.0*x147) + (1.0/2.0)*x117*x118*(-x146 - x147));
   out_6543693310212660619[2] = x139*(x123*(-x170 + x171 + x172 + x173) + x137*(4*a_2*b_0*c_0 + 4*a_2*b_1*c_1 - x175 - x176 - x177 - x178 + x179 + x180 + x181 - x182 - x183 - x184 - x185 - x186 - x187 + x27 + x68 + x69 + x70 + x71)) + x76*(-x101*(x140*x164 + x141*x81 - x91 + x94) + (1.0/2.0)*x106*x108*(x141*x166 + x164*x165 + x167) - x116*(-1.0/2.0*x168 - 1.0/2.0*x169) + (1.0/2.0)*x117*x118*(-x168 - x169));
   out_6543693310212660619[3] = x139*(x123*(-x121 - x194 - x195 + x35) + x137*(4*a_1*b_0*c_1 + 4*a_2*b_0*c_2 + x127 + x128 - x130 - x132 + x133 + x134 - x135 + x196 + x197 + x198 + x199 - x200 - x201 - x202 - x55 - x56 - x66 - x72)) + x76*(-x101*(x188*x85 + x189*x81) + (1.0/2.0)*x106*x108*(x102*x188 + x166*x189) - x116*(-1.0/2.0*x191 - 1.0/2.0*x193) + (1.0/2.0)*x117*x118*(-x191 - x193));
   out_6543693310212660619[4] = x139*(x123*(x150 - x206 + x207 + x24) + x137*(4*a_0*b_1*c_0 + 4*a_2*b_1*c_2 + x155 + x156 + x160 - x162 - x20 - x208 - x209 + x211 + x213 - x215 - x216 - x217 - x36 + x44 + x60 - x63 - x64 + x73)) + x76*(-x101*(x140*x189 + x85*x93) + (1.0/2.0)*x106*x108*(x102*x93 + x165*x189) - x116*(-1.0/2.0*x204 - 1.0/2.0*x205) + (1.0/2.0)*x117*x118*(-x204 - x205));
   out_6543693310212660619[5] = x139*(x123*(-x17 - x172 + x214 - x220) + x137*(4*a_0*b_2*c_0 + 4*a_1*b_2*c_1 + x177 + x178 - x181 + x183 + x185 - x186 - x221 - x222 + x224 + x225 - x226 - x227 - x228 - x27 + x61 + x67 - x70 - x71)) + x76*(-x101*(x140*x78 + x81*x93) + (1.0/2.0)*x106*x108*(x165*x78 + x166*x93) - x116*(-1.0/2.0*x218 - 1.0/2.0*x219) + (1.0/2.0)*x117*x118*(-x218 - x219));
   out_6543693310212660619[6] = x139*(x123*(x119 - x120 + x195 + x233) + x137*(4*a_1*b_1*c_0 + 4*a_2*b_2*c_0 + x125 + x126 - x129 - x131 - x136 - x196 - x197 - x198 - x199 + x200 + x201 - x202 + x42 + x43 - x58 - x59 + x66 + x72)) + x76*(-x101*(x79*x81 + x85*x87) + (1.0/2.0)*x106*x108*(x102*x87 + x166*x79) - x116*(-1.0/2.0*x230 - 1.0/2.0*x232) + (1.0/2.0)*x117*x118*(-x230 - x232));
   out_6543693310212660619[7] = x139*(x123*(-x148 + x149 - x207 - x238) + x137*(4*a_0*b_0*c_1 + 4*a_2*b_2*c_1 + x153 + x154 - x157 - x158 + x159 + x161 - x163 + x208 + x209 - x211 - x213 + x215 + x216 - x217 - x60 - x62 - x65 - x73)) + x76*(-x101*(x140*x79 + x234*x85) + (1.0/2.0)*x106*x108*(x102*x234 + x165*x79) - x116*(-1.0/2.0*x236 - 1.0/2.0*x237) + (1.0/2.0)*x117*x118*(-x236 - x237));
   out_6543693310212660619[8] = x139*(x123*(x170 - x171 + x220 + x242) + x137*(4*a_0*b_0*c_2 + 4*a_1*b_1*c_2 + x175 + x176 - x179 - x180 + x182 + x184 - x187 + x221 + x222 - x224 - x225 + x226 + x227 - x228 - x61 - x67 - x68 - x69)) + x76*(-x101*(x140*x239 + x234*x81) + (1.0/2.0)*x106*x108*(x165*x239 + x166*x234) - x116*(-1.0/2.0*x240 - 1.0/2.0*x241) + (1.0/2.0)*x117*x118*(-x240 - x241));
   out_6543693310212660619[9] = x243*(-x122 + x194 - x233 - x35) + x76*(-x101*x99 - 1.0/2.0*x105*x106*x108);
   out_6543693310212660619[10] = x243*(x151 + x206 + x238 - x24) + x76*(x101*x98 + (1.0/2.0)*x106*x108*(x142 - x143));
   out_6543693310212660619[11] = x243*(x17 - x173 - x214 - x242) + x76*(-x101*x95 - 1.0/2.0*x106*x108*x167);

}

void vertex_face_hessian(double a_0, double a_1, double a_2, double b_0, double b_1, double b_2, double c_0, double c_1, double c_2, double d_0, double d_1, double d_2, double d_h, double *out_3216172810630303951) {
   ...
   const double x44 = -x11 + x12 + x13 + x14 + x15 - x18 - x2 - x21 - x24 - x27 - x30 - x33 + x35 + x37 + x39 + x41 + x42 + x43 - x5 - x8;
   ...
   const double x61 = a_0*x45 + a_0*x46 + a_0*x47 - a_0*x53 - a_0*x54 - a_0*x55 - a_1*x36 + a_1*x48 + a_1*x49 + a_1*x50 - a_1*x56 - a_1*x57 + a_2*x34 + a_2*x51 + a_2*x52 - a_2*x58 - a_2*x59 - a_2*x60 - b_0*x47 + b_0*x53 - c_0*x46 + c_0*x54 - d_0*x45 + d_0*x55;
   ...
   const double x96 = -a_1*x85 - a_1*x86 - a_1*x87 - a_1*x88 - a_2*x91 - a_2*x92 - a_2*x93 - a_2*x94 - b_0*x14 - b_0*x15 - c_0*x12 - c_0*x13 - c_0*x90 - c_0*x95 + x0*x78 + x0*x80 + x0*x82 + x0*x9 + x16*x38 + x19*x40 - x23*x62 + x23*x63 + x26*x62 - x26*x63 + x26*x70 + x26*x71 - x29*x64 + x29*x65 + x3*x6 + x3*x78 + x3*x79 + x3*x80 + x32*x64 - x32*x65 + x32*x74 + x32*x75 - x34*x38 + x34*x62 - x36*x40 + x36*x64 + x55*x67 - x55*x77 + x6*x78 + x6*x81 + x6*x82 - x66*x67 + x66*x69 + x67*x68 - x68*x69 + x68*x72 + x68*x73 + x76*x77 - x78*x83 - x78*x84 + x78*x9 + x79*x80 + x79*x81 - x79*x84 + x79*x9 + x80*x82 + x81*x82 + x81*x9 - x82*x83;
   ...
   const double x188 = (1.0/2.0)*x135*x138*x156 + (1.0/2.0)*x136*x178*x181 - x141*x167 - x164*x174;
   ...
   const double x249 = x232 + x233 + x234 + x235 - x236 - x237 - x238 - x240 - x241 - x242 + x243 + x244 + x245 + x246 + x247 + x248 - x85 - x86 - x87 - x88;
   ...
   const double x279 = (1.0/2.0)*x135*x138*x271 + (1.0/2.0)*x136*x178*x278 - x141*x265 - x174*x277;
   ...
   const double x320 = 8*a_1*b_0*c_0 + 8*a_1*b_2*c_2 + x296 + x297 + x298 + x299 - x300 - x301 - x302 - x303 + x305 + x306 + x308 + x309 - x310 - x311 - x312 - x313 - x316 - x319;
   const double x321 = x144*x249 + x146*x256 + x147*(x157*x281 - x169*x277 - x170*x282 + x175*x283 + x185*x288 - x187*x289 - x265*x284 + x278*x285 + x286*x287) + x190*x279 + x230*(x104*x292 + x108*(x239 + x293 + x294 + x70) + x198*x257 + x229*x320 + x259*x295) + x260*x261;
   ...
   const double x340 = x323 + x324 + x325 + x326 - x327 - x328 - x329 - x331 - x332 - x333 + x334 + x335 + x336 + x337 + x338 + x339 - x91 - x92 - x93 - x94;
   ...
   const double x361 = (1.0/2.0)*x135*x138*x356 + (1.0/2.0)*x136*x178*x360 - x141*x350 - x174*x359;
   ...
   const double x393 = 8*a_2*b_0*c_0 + 8*a_2*b_1*c_1 + x370 + x371 + x372 + x373 - x374 - x375 - x376 - x377 + x379 + x380 + x381 + x382 - x383 - x384 - x385 - x386 - x389 - x392;
   const double x394 = x144*x340 + x146*x346 + x147*(x157*x362 - x169*x359 - x172*x282 + x176*x283 + x185*x364 - x187*x365 - x284*x350 + x285*x360 + x287*x363) + x190*x361 + x230*(x104*x368 + x108*(x254 + x330 + x369 + x74) + x198*x345 + x229*x393 + x295*x347) + x261*x348;
   ...
   const double x406 = -x14 - x15 + x2 - x225 - x226 + x27 + x33 - x39 - x395 - x396 - x398 - x400 + x402 + x404 + x405 - x41 + x42 + x5 + x90 + x95;
   ...
   const double x425 = (1.0/2.0)*x135*x138*x416 + (1.0/2.0)*x136*x178*x424 - x141*x413 - x174*x423;
   ...
   const double x452 = 8*a_1*b_0*c_1 + 8*a_2*b_0*c_2 - x200 - x201 + x208 + x209 - x212 - x215 + x218 + x219 - x224 + x443 + x444 - x445 - x446 + x447 + x448 - x449 - x450 - x451;
   const double x453 = x144*x406 + x146*x410 + x147*(x157*x429 - x169*x423 - x174*(x170*x411 + x430) + x180*(x175*x411 + x431) + x185*x433 - x187*x434 - x284*x413 + x285*x424 + x287*x432) + x190*x425 + x230*(x104*x436 + x108*(x195 + x439 + x442) + x198*x426 + x229*x452 + x295*x427) + x261*x428;
   ...
   const double x465 = -x234 - x235 + x240 + x242 - x244 - x246 + x247 - x317 - x318 - x454 - x455 + x456 + x457 - x459 - x460 + x462 + x463 + x464 + x86 + x87;
   ...
   const double x482 = (1.0/2.0)*x135*x138*x475 + (1.0/2.0)*x136*x178*x481 - x141*x472 - x174*x480;
   ...
   const double x511 = 8*a_0*b_1*c_0 + 8*a_2*b_1*c_2 - x296 - x297 + x302 + x303 - x306 - x309 + x311 + x313 - x316 + x502 + x503 - x504 - x505 + x506 + x507 - x508 - x509 - x510;
   const double x512 = x144*x465 + x146*x471 + x147*(x141*x485 + x157*x486 - x169*x480 - x174*(x127*x170 + x349) + x180*(x127*x175 + x490) + x185*x492 - x187*x493 - x284*x472 + x285*x481 + x287*x491 + x488*x489) + x190*x482 + x230*(x104*x495 + x108*(-x239 - x496 - x497 - x499 - x501) + x198*x470 + x229*x511 + x258*x488 + x295*x483) + x261*x484;
   ...
   const double x523 = -x325 - x326 + x331 + x333 - x335 - x337 + x338 - x390 - x391 - x513 - x514 + x515 + x516 - x518 - x519 + x520 + x521 + x522 + x93 + x94;
   ...
   const double x535 = (1.0/2.0)*x135*x138*x530 + (1.0/2.0)*x136*x178*x534 - x141*x527 - x174*x533;
   ...
   const double x564 = 8*a_0*b_2*c_0 + 8*a_1*b_2*c_1 - x370 - x371 + x376 + x377 - x380 - x382 + x384 + x386 - x389 + x555 + x556 - x557 - x558 + x559 + x560 - x561 - x562 - x563;
   const double x565 = x144*x523 + x146*x526 + x147*(-x141*x539 + x157*x540 - x169*x533 - x174*(x127*x172 + x280) + x180*(x127*x176 + x270) + x185*x545 - x187*x546 - x284*x527 + x285*x534 + x287*x544 + x489*x543) + x190*x535 + x230*(x104*x548 + x108*(-x330 - x549 - x550 - x552 - x554) + x198*x536 + x229*x564 + x258*x543 + x295*x537) + x261*x538;
   const double x566 = x11 - x12 - x13 - x221 - x223 + x24 + x30 - x35 - x37 + x395 + x396 + x398 + x400 - x402 - x404 + x405 + x43 + x8 - x90 - x95;
   ...
   const double x582 = (1.0/2.0)*x135*x138*x575 + (1.0/2.0)*x136*x178*x581 - x141*x572 - x174*x580;
   ...
   const double x596 = 8*a_1*b_1*c_0 + 8*a_2*b_2*c_0 - x203 - x204 + x206 + x207 - x210 - x213 + x216 + x217 - x227 - x443 - x444 + x445 + x446 - x447 - x448 + x449 + x450 - x451;
   const double x597 = x144*x566 + x146*x571 + x147*(x157*x585 - x169*x580 - x174*(x113*x170 + x586) + x180*(x113*x175 + x587) + x185*x589 - x187*x590 - x284*x572 + x285*x581 + x287*x588) + x190*x582 + x230*(x104*x592 + x108*(-x593 - x594 - x595) + x198*x570 + x229*x596 + x295*x583) + x261*x584;
   const double x598 = -x232 - x233 + x238 + x241 - x243 - x245 + x248 - x314 - x315 + x454 + x455 - x456 - x457 + x459 + x460 - x462 - x463 + x464 + x85 + x88;
   ...
   const double x612 = (1.0/2.0)*x135*x138*x605 + (1.0/2.0)*x136*x178*x611 - x141*x602 - x174*x610;
   ...
   const double x628 = 8*a_0*b_0*c_1 + 8*a_2*b_2*c_1 - x298 - x299 + x300 + x301 - x305 - x308 + x310 + x312 - x319 - x502 - x503 + x504 + x505 - x506 - x507 + x508 + x509 - x510;
   const double x629 = x144*x598 + x146*x600 + x147*(-x141*x616 + x157*x617 - x169*x610 - x174*(x129 + x170*x601) + x180*(x175*x601 + x355) + x185*x621 - x187*x622 - x284*x602 + x285*x611 + x287*x620 + x489*x619) + x190*x612 + x230*(x104*x624 + x108*(-x500 - x524 - x626 - x627 - x70) + x198*x613 + x229*x628 + x258*x619 + x295*x614) + x261*x615;
   const double x630 = -x323 - x324 + x329 + x332 - x334 - x336 + x339 - x387 - x388 + x513 + x514 - x515 - x516 + x518 + x519 - x520 - x521 + x522 + x91 + x92;
   ...
   const double x644 = (1.0/2.0)*x135*x138*x638 + (1.0/2.0)*x136*x178*x643 - x141*x635 - x174*x642;
   ...
   const double x659 = 8*a_0*b_0*c_2 + 8*a_1*b_1*c_2 - x372 - x373 + x374 + x375 - x379 - x381 + x383 + x385 - x392 - x555 - x556 + x557 + x558 - x559 - x560 + x561 + x562 - x563;
   const double x660 = x144*x630 + x146*x633 + x147*(x141*x647 + x157*x648 - x169*x642 - x174*(x134 + x172*x601) + x180*(x176*x601 + x650) + x185*x652 - x187*x653 - x284*x635 + x285*x643 + x287*x651 + x489*x649) + x190*x644 + x230*(x104*x655 + x108*(-x467 - x553 - x657 - x658 - x74) + x198*x632 + x229*x659 + x258*x649 + x295*x645) + x261*x646;
   ...
   const double x672 = x146*x662 + x147*(-x121*x284 + x157*x666 + x667*x668) + x190*x671 + x230*(x104*x670 + x198*x663) + x663*x665;
   ...
   const double x679 = x146*x677 + x147*(x134*x157 - x141*x172 + x162*x489 - x284*x675 + x650*x668) + x190*x676 + x230*(x104*x678 + x162*x258 + x198*x674) + x665*x674;
   ...
   const double x688 = x146*x681 + x147*(-x129*x284 - x141*x148 + x157*x683 + x175*x489 + x668*x684) + x190*x685 + x230*(x104*x687 + x175*x258 + x198*x682) + x665*x682;
   ...
   const double x713 = x147*(-x170*x172*x174 + x170*x176*x180 - x350*x692 - x359*x707 + x360*x709 + x362*x691 + x363*x708 + x364*x695 - x365*x696) + x230*(x108*(x101 + x710 + x711 + x72) + x345*x712 + x347*x704 + x368*x698 + x393*x705) + x340*x689 + x346*x690 + x348*x706 + x361*x697;
   const double x714 = -x488;
   const double x715 = -x62;
   const double x716 = 4*x23;
   const double x717 = 4*x26;
   const double x718 = x63 - x717;
   const double x719 = x147*(-x141*x485 - x174*(x129 + x263*x411) + x180*(x273*x411 + x355) - x413*x692 - x423*x707 + x424*x709 + x429*x691 + x432*x708 + x433*x695 - x434*x696 + x489*x714) + x230*(x108*(-x239 - x626 - x715 - x716 - x718) + x258*x714 + x426*x712 + x427*x704 + x436*x698 + x452*x705) + x406*x689 + x410*x690 + x425*x697 + x428*x706;
   ...
   const double x727 = x147*(-x174*(x430 + x720) + x180*(x431 + x721) - x472*x692 - x480*x707 + x481*x709 + x486*x691 + x491*x708 + x492*x695 - x493*x696) + x230*(x108*(x439 + x701 + x726) + x470*x712 + x483*x704 + x495*x698 + x511*x705) + x465*x689 + x471*x690 + x482*x697 + x484*x706;
   ...
   const double x737 = x147*(x141*x728 - x174*(x118*x172 + x166) + x180*(x118*x176 + x731) + x489*x730 - x527*x692 - x533*x707 + x534*x709 + x540*x691 + x544*x708 + x545*x695 - x546*x696) + x230*(x108*(-x567 - x711 - x732 - x734 - x736) + x258*x730 + x536*x712 + x537*x704 + x548*x698 + x564*x705) + x523*x689 + x526*x690 + x535*x697 + x538*x706;
   const double x738 = x62 - x716;
   const double x739 = x147*(x141*x616 - x174*(x113*x263 + x349) + x180*(x113*x273 + x490) + x489*x618 - x572*x692 - x580*x707 + x581*x709 + x585*x691 + x588*x708 + x589*x695 - x590*x696) + x230*(x108*(-x499 - x680 - x70 - x717 - x738) + x258*x618 + x570*x712 + x583*x704 + x592*x698 + x596*x705) + x566*x689 + x571*x690 + x582*x697 + x584*x706;
   const double x740 = x263*x601;
   const double x741 = x273*x601;
   const double x742 = x722 + x84;
   const double x743 = -x702 + x725;
   const double x744 = x147*(-x174*(x586 + x740) + x180*(x587 + x741) - x602*x692 - x610*x707 + x611*x709 + x617*x691 + x620*x708 + x621*x695 - x622*x696) + x230*(x108*(-x594 - x742 - x743) + x613*x712 + x614*x704 + x624*x698 + x628*x705) + x598*x689 + x600*x690 + x612*x697 + x615*x706;
   ...
   const double x751 = x147*(-x141*x745 - x174*(x121 + x172*x634) + x180*(x155 + x176*x634) + x489*x747 - x635*x692 - x642*x707 + x643*x709 + x648*x691 + x651*x708 + x652*x695 - x653*x696) + x230*(x108*(-x407 - x72 - x735 - x749 - x750) + x258*x747 + x632*x712 + x645*x704 + x655*x698 + x659*x705) + x630*x689 + x633*x690 + x644*x697 + x646*x706;
   const double x752 = x279*x664;
   const double x753 = x182*x708;
   const double x754 = x147*(-x121*x692 - x141*x151 + x176*x489 + x666*x691 + x667*x753) + x230*(x176*x258 + x663*x712 + x670*x698) + x662*x690 + x663*x752 + x671*x697;
   const double x755 = x147*(x134*x691 + x650*x753 - x675*x692) + x230*(x674*x712 + x678*x698) + x674*x752 + x676*x697 + x677*x690;
   const double x756 = x147*(-x129*x692 - x141*x264 + x273*x489 + x683*x691 + x684*x753) + x230*(x258*x273 + x682*x712 + x687*x698) + x681*x690 + x682*x752 + x685*x697;
   ...
   const double x778 = x147*(x141*x539 - x174*(x134 + x263*x412) + x180*(x273*x412 + x650) - x413*x760 - x423*x770 + x424*x772 + x429*x759 + x432*x771 + x433*x761 - x434*x762 + x489*x542) + x230*(x108*(-x330 - x657 - x773 - x774 - x776) + x258*x542 + x426*x767 + x427*x777 + x436*x764 + x452*x768) + x406*x757 + x410*x758 + x425*x763 + x428*x769;
   const double x779 = -x730;
   const double x780 = -x568;
   const double x781 = 4*x307;
   const double x782 = 4*x76;
   const double x783 = x408 - x782;
   const double x784 = x147*(-x141*x728 - x174*(x121 + x148*x412) + x180*(x155 + x159*x412) - x472*x760 - x480*x770 + x481*x772 + x486*x759 + x489*x779 + x491*x771 + x492*x761 - x493*x762) + x230*(x108*(-x711 - x749 - x780 - x781 - x783) + x258*x779 + x470*x767 + x483*x777 + x495*x764 + x511*x768) + x465*x757 + x471*x758 + x482*x763 + x484*x769;
   const double x785 = x147*(-x174*(x118*x148 + x720) + x180*(x118*x159 + x721) - x527*x760 - x533*x770 + x534*x772 + x540*x759 + x544*x771 + x545*x761 - x546*x762) + x230*(x108*(x442 + x726 + x765) + x536*x767 + x537*x777 + x548*x764 + x564*x768) + x523*x757 + x526*x758 + x535*x763 + x538*x769;
   const double x786 = -x649;
   const double x787 = x64 - x774;
   const double x788 = x147*(-x141*x647 - x174*(x119*x263 + x280) + x180*(x119*x273 + x270) + x489*x786 - x572*x760 - x580*x770 + x581*x772 + x585*x759 + x588*x771 + x589*x761 - x590*x762) + x230*(x108*(-x552 - x673 - x74 - x775 - x787) + x258*x786 + x570*x767 + x583*x777 + x592*x764 + x596*x768) + x566*x757 + x571*x758 + x582*x763 + x584*x769;
   const double x789 = x568 - x781;
   const double x790 = x147*(x141*x745 - x174*(x119*x148 + x166) + x180*(x119*x159 + x731) + x489*x746 - x602*x760 - x610*x770 + x611*x772 + x617*x759 + x620*x771 + x621*x761 - x622*x762) + x230*(x108*(-x661 - x72 - x734 - x782 - x789) + x258*x746 + x613*x767 + x614*x777 + x624*x764 + x628*x768) + x598*x757 + x600*x758 + x612*x763 + x615*x769;
   const double x791 = x722 + x83;
   const double x792 = x147*(-x174*(x148*x634 + x740) + x180*(x159*x634 + x741) - x635*x760 - x642*x770 + x643*x772 + x648*x759 + x651*x771 + x652*x761 - x653*x762) + x230*(x108*(-x595 - x743 - x791) + x632*x767 + x645*x777 + x655*x764 + x659*x768) + x630*x757 + x633*x758 + x644*x763 + x646*x769;
   const double x793 = x361*x664;
   const double x794 = x182*x771;
   const double x795 = x147*(-x121*x760 - x141*x170 + x159*x489 + x666*x759 + x667*x794) + x230*(x159*x258 + x663*x767 + x670*x764) + x662*x758 + x663*x793 + x671*x763;
   const double x796 = x147*(x134*x759 - x141*x263 + x274*x489 + x650*x794 - x675*x760) + x230*(x258*x274 + x674*x767 + x678*x764) + x674*x793 + x676*x763 + x677*x758;
   const double x797 = x147*(-x129*x760 + x683*x759 + x684*x794) + x230*(x682*x767 + x687*x764) + x681*x758 + x682*x793 + x685*x763;
   ...
   const double x823 = x147*(-x118*x817 + x417*x818 - x472*x801 - x480*x816 + x481*x820 + x486*x800 + x491*x819 + x492*x805 - x493*x806) + x230*(x108*(x239 + x524 + x680 + x821) + x470*x813 + x483*x822 + x495*x808 + x511*x814) + x465*x798 + x471*x799 + x482*x807 + x484*x815;
   const double x824 = a_0*x322;
   const double x825 = x147*(-x115*x817 + x420*x818 - x527*x801 - x533*x816 + x534*x820 + x540*x800 + x544*x819 + x545*x805 - x546*x806) + x230*(x108*(x330 + x467 + x673 + x824) + x536*x813 + x537*x822 + x548*x808 + x564*x814) + x523*x798 + x526*x799 + x535*x807 + x538*x815;
   const double x826 = x115*x119;
   const double x827 = x119*x420;
   const double x828 = -x399 + x437 + x809;
   const double x829 = -x397 + x440 + x811;
   const double x830 = x147*(-x174*(x113*x118 + x826) + x180*(x113*x417 + x827) - x572*x801 - x580*x816 + x581*x820 + x585*x800 + x588*x819 + x589*x805 - x590*x806) + x230*(x108*(x593 + x828 + x829) + x570*x813 + x583*x822 + x592*x808 + x596*x814) + x566*x798 + x571*x799 + x582*x807 + x584*x815;
   const double x831 = x322 + x487;
   const double x832 = x147*(-x141*x165 - x174*(x118*x601 + x349) + x180*(x417*x601 + x490) + x489*x831 - x602*x801 - x610*x816 + x611*x820 + x617*x800 + x620*x819 + x621*x805 - x622*x806) + x230*(x108*(-x294 - x501 - x625 - x738 - x821) + x258*x831 + x613*x813 + x614*x822 + x624*x808 + x628*x814) + x598*x798 + x600*x799 + x612*x807 + x615*x815;
   const double x833 = x231 + x541;
   const double x834 = -x833;
   const double x835 = x147*(-x131*x141 - x174*(x115*x601 + x280) + x180*(x270 + x420*x601) + x489*x834 - x635*x801 - x642*x816 + x643*x820 + x648*x800 + x651*x819 + x652*x805 - x653*x806) + x230*(x108*(-x254 - x554 - x656 - x787 - x824) + x258*x834 + x632*x813 + x645*x822 + x655*x808 + x659*x814) + x630*x798 + x633*x799 + x644*x807 + x646*x815;
   const double x836 = x425*x664;
   const double x837 = x182*x819;
   const double x838 = x147*(-x121*x801 + x666*x800 + x667*x837) + x230*(x663*x813 + x670*x808) + x662*x799 + x663*x836 + x671*x807;
   const double x839 = x147*(-x115*x141 + x134*x800 + x421*x489 + x650*x837 - x675*x801) + x230*(x258*x421 + x674*x813 + x678*x808) + x674*x836 + x676*x807 + x677*x799;
   const double x840 = x147*(-x129*x801 - x141*x411 + x417*x489 + x683*x800 + x684*x837) + x230*(x258*x417 + x682*x813 + x687*x808) + x681*x799 + x682*x836 + x685*x807;
   ...
   const double x863 = x147*(-x115*x118*x174 + x118*x180*x420 - x527*x844 - x533*x858 + x534*x860 + x540*x843 + x544*x859 + x545*x849 - x546*x850) + x230*(x108*(x407 + x661 + x711 + x861) + x536*x855 + x537*x862 + x548*x852 + x564*x856) + x523*x841 + x526*x842 + x535*x851 + x538*x857;
   const double x864 = -x831;
   const double x865 = x147*(-x123*x141 - x174*(x113*x845 + x129) + x180*(x113*x847 + x355) + x489*x864 - x572*x844 - x580*x858 + x581*x860 + x585*x843 + x588*x859 + x589*x849 - x590*x850) + x230*(x108*(-x293 - x498 - x627 - x718 - x821) + x258*x864 + x570*x855 + x583*x862 + x592*x852 + x596*x856) + x566*x841 + x571*x842 + x582*x851 + x584*x857;
   const double x866 = x601*x845;
   const double x867 = x601*x847;
   const double x868 = x723 - x724 + x853;
   const double x869 = x147*(-x174*(x826 + x866) + x180*(x827 + x867) - x602*x844 - x610*x858 + x611*x860 + x617*x843 + x620*x859 + x621*x849 - x622*x850) + x230*(x108*(x742 + x828 + x868) + x613*x855 + x614*x862 + x624*x852 + x628*x856) + x598*x841 + x600*x842 + x612*x851 + x615*x857;
   const double x870 = x476 + x729;
   const double x871 = x147*(-x141*x262 - x174*(x115*x634 + x166) + x180*(x420*x634 + x731) + x489*x870 - x635*x844 - x642*x858 + x643*x860 + x648*x843 + x651*x859 + x652*x849 - x653*x850) + x230*(x108*(-x101 - x736 - x748 - x789 - x861) + x258*x870 + x632*x855 + x645*x862 + x655*x852 + x659*x856) + x630*x841 + x633*x842 + x644*x851 + x646*x857;
   const double x872 = x482*x664;
   const double x873 = x182*x859;
   const double x874 = x147*(-x121*x844 - x141*x412 + x420*x489 + x666*x843 + x667*x873) + x230*(x258*x420 + x663*x855 + x670*x852) + x662*x842 + x663*x872 + x671*x851;
   const double x875 = x147*(x134*x843 + x650*x873 - x675*x844) + x230*(x674*x855 + x678*x852) + x674*x872 + x676*x851 + x677*x842;
   const double x876 = x147*(-x127*x141 - x129*x844 + x489*x847 + x683*x843 + x684*x873) + x230*(x258*x847 + x682*x855 + x687*x852) + x681*x842 + x682*x872 + x685*x851;
   ...
   const double x892 = x147*(-x141*x150 - x174*(x119*x845 + x134) + x180*(x119*x847 + x650) + x489*x833 - x572*x888 - x580*x880 + x581*x889 + x585*x879 + x588*x890 + x589*x881 - x590*x882) + x230*(x108*(-x369 - x551 - x658 - x776 - x824) + x258*x833 + x570*x891 + x583*x885 + x592*x884 + x596*x886) + x566*x877 + x571*x878 + x582*x883 + x584*x887;
   const double x893 = -x870;
   const double x894 = x147*(-x112*x141 - x174*(x119*x411 + x121) + x180*(x119*x418 + x155) + x489*x893 - x602*x888 - x610*x880 + x611*x889 + x617*x879 + x620*x890 + x621*x881 - x622*x882) + x230*(x108*(-x710 - x733 - x750 - x783 - x861) + x258*x893 + x613*x891 + x614*x885 + x624*x884 + x628*x886) + x598*x877 + x600*x878 + x612*x883 + x615*x887;
   const double x895 = x147*(-x174*(x411*x634 + x866) + x180*(x418*x634 + x867) - x635*x888 - x642*x880 + x643*x889 + x648*x879 + x651*x890 + x652*x881 - x653*x882) + x230*(x108*(x791 + x829 + x868) + x632*x891 + x645*x885 + x655*x884 + x659*x886) + x630*x877 + x633*x878 + x644*x883 + x646*x887;
   const double x896 = x535*x664;
   const double x897 = x182*x890;
   const double x898 = x147*(-x118*x141 - x121*x888 + x418*x489 + x666*x879 + x667*x897) + x230*(x258*x418 + x663*x891 + x670*x884) + x662*x878 + x663*x896 + x671*x883;
   const double x899 = x147*(x134*x879 - x141*x845 + x477*x489 + x650*x897 - x675*x888) + x230*(x258*x477 + x674*x891 + x678*x884) + x674*x896 + x676*x883 + x677*x878;
   const double x900 = x147*(-x129*x888 + x683*x879 + x684*x897) + x230*(x682*x891 + x687*x884) + x681*x878 + x682*x896 + x685*x883;
   ...
   const double x925 = x147*(-x602*x919 - x610*x904 + x611*x922 + x617*x903 + x620*x923 + x621*x910 - x622*x911 - x634*x920 + x640*x921) + x230*(x108*(x496 + x70 + x715 + x821) + x613*x916 + x614*x924 + x624*x913 + x628*x917) + x598*x901 + x600*x902 + x612*x912 + x615*x918;
   const double x926 = x147*(-x635*x919 - x642*x904 + x643*x922 + x648*x903 + x651*x923 + x652*x910 - x653*x911 - x906*x920 + x908*x921) + x230*(x108*(x549 + x74 + x773 + x824) + x632*x916 + x645*x924 + x655*x913 + x659*x917) + x630*x901 + x633*x902 + x644*x912 + x646*x918;
   const double x927 = x582*x664;
   const double x928 = x182*x923;
   const double x929 = x147*(-x121*x919 + x666*x903 + x667*x928) + x230*(x663*x916 + x670*x913) + x662*x902 + x663*x927 + x671*x912;
   const double x930 = x147*(x134*x903 - x141*x906 + x489*x578 + x650*x928 - x675*x919) + x230*(x258*x578 + x674*x916 + x678*x913) + x674*x927 + x676*x912 + x677*x902;
   const double x931 = x147*(-x113*x141 - x129*x919 + x489*x640 + x683*x903 + x684*x928) + x230*(x258*x640 + x682*x916 + x687*x913) + x681*x902 + x682*x927 + x685*x912;
   ...
   const double x950 = x147*(-x174*x634*x906 + x180*x634*x908 - x602*x946 + x620*x948 - x635*x935 + x648*x934 + x651*x947 + x652*x938 - x653*x939) + x230*(x108*(x567 + x72 + x780 + x861) + x613*x949 + x632*x943 + x655*x941 + x659*x944) + x612*x945 + x630*x932 + x633*x933 + x644*x940;
   const double x951 = x612*x664;
   const double x952 = x182*x947;
   const double x953 = x147*(-x119*x141 - x121*x935 + x489*x908 + x666*x934 + x667*x952) + x230*(x258*x908 + x663*x943 + x670*x941) + x662*x933 + x663*x951 + x671*x940;
   const double x954 = x147*(x134*x934 + x650*x952 - x675*x935) + x230*(x674*x943 + x678*x941) + x674*x951 + x676*x940 + x677*x933;
   const double x955 = x147*(-x129*x935 - x141*x601 + x489*x606 + x683*x934 + x684*x952) + x230*(x258*x606 + x682*x943 + x687*x941) + x681*x933 + x682*x951 + x685*x940;
   ...
   const double x961 = x147*(-x121*x946 - x141*x634 + x489*x576 + x666*x957 + x667*x960) + x230*(x258*x576 + x663*x949 + x670*x958) + x662*x956 + x663*x959 + x671*x945;
   const double x962 = x147*(-x124*x141 + x134*x957 + x489*x607 + x650*x960 - x675*x946) + x230*(x258*x607 + x674*x949 + x678*x958) + x674*x959 + x676*x945 + x677*x956;
   const double x963 = x147*(-x129*x946 + x683*x957 + x684*x960) + x230*(x682*x949 + x687*x958) + x681*x956 + x682*x959 + x685*x945;
   ...
   out_3216172810630303951[0] = -x103*x146 + x144*x44 + x147*(x157*(x121 + x149 + x152) - 2*x164*x169 - x174*(x171 + x173) + x180*(x148*x175 + x177) + x181*x183 + x185*(-2*x160 - 2*x163) - x187*(-3.0/2.0*x160 - 3.0/2.0*x163)) + 2*x188*x190 + x230*(2*x103*x198 + x104*(x191 + x192 + x46 - x54) + x108*(-x193 - x194 - x195 - x196) + x229*(8*a_0*b_1*c_1 + 8*a_0*b_2*c_2 + x200 + x201 + x203 + x204 - x206 - x207 - x208 - x209 + x210 + x212 + x213 + x215 - x216 - x217 - x218 - x219 - x224 - x227));
   ...
   out_3216172810630303951[13] = x147*(-x174*(x173 + x693) + x180*(x177 + x694) - 2*x265*x692 + x278*x286 + x281*x691 + x288*x695 - x289*x696) + x230*(x108*(-x194 - x699 - x701 - x703) + 2*x259*x704 + x292*x698 + x320*x705) + x249*x689 + x256*x690 + 2*x279*x697;
   ...
   out_3216172810630303951[26] = x147*(-x174*(x171 + x693) + x180*(x159*x170 + x694) - 2*x350*x760 + x360*x363 + x362*x759 + x364*x761 - x365*x762) + x230*(x108*(-x193 - x699 - x765 - x766) + 2*x345*x767 + x368*x764 + x393*x768) + x340*x757 + x346*x758 + 2*x361*x763;
   ...
   out_3216172810630303951[39] = x147*(-x174*(x802 + x803) + x180*(x411*x417 + x804) - 2*x413*x801 + x424*x432 + x429*x800 + x433*x805 - x434*x806) + x230*(x108*(-x195 - x810 - x812) + 2*x426*x813 + x436*x808 + x452*x814) + x406*x798 + x410*x799 + 2*x425*x807;
   ...
   out_3216172810630303951[52] = x147*(-x174*(x803 + x846) + x180*(x804 + x848) - 2*x472*x844 + x481*x491 + x486*x843 + x492*x849 - x493*x850) + x230*(x108*(-x701 - x810 - x854) + 2*x470*x855 + x495*x852 + x511*x856) + x465*x841 + x471*x842 + 2*x482*x851;
   ...
   out_3216172810630303951[65] = x147*(-x174*(x802 + x846) + x180*(x118*x418 + x848) - 2*x533*x880 + x534*x544 + x540*x879 + x545*x881 - x546*x882) + x230*(x108*(-x765 - x812 - x854) + 2*x537*x885 + x548*x884 + x564*x886) + x523*x877 + x526*x878 + 2*x535*x883;
   ...
   out_3216172810630303951[78] = x147*(-x174*(x905 + x907) + x180*(x113*x640 + x909) - 2*x580*x904 + x581*x588 + x585*x903 + x589*x910 - x590*x911) + x230*(x108*(-x196 - x914 - x915) + 2*x570*x916 + x592*x913 + x596*x917) + x566*x901 + x571*x902 + 2*x582*x912;
   ...
   out_3216172810630303951[91] = x147*(-x174*(x907 + x936) + x180*(x909 + x937) - 2*x602*x935 + x611*x620 + x617*x934 + x621*x938 - x622*x939) + x230*(x108*(-x703 - x914 - x942) + 2*x613*x943 + x624*x941 + x628*x944) + x598*x932 + x600*x933 + 2*x612*x940;
   ...
   out_3216172810630303951[104] = x143*x630*x646 + x147*(-x174*(x905 + x936) + x180*(x576*x634 + x937) + x184*x643*x652 - x186*x642*x653 - 2*x635*x946 + x643*x651 + x648*x957) + x230*(x108*(-x766 - x915 - x942) + x228*x645*x659 + 2*x632*x949 + x655*x958) + x633*x956 + 2*x644*x945;
   ...
   out_3216172810630303951[143] = x143*x682*x686 + x683*x684*x966 + 2*x685*x975;
