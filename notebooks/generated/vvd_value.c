...
float vvd_value(float a_0, float a_1, float a_2, float b_0, float b_1, float b_2) {

   float vvd_value_result;
   vvd_value_result = sqrt(pow(a_0 - b_0, 2) + pow(a_1 - b_1, 2) + pow(a_2 - b_2, 2));
   return vvd_value_result;

}

void vvd_grad(float a_0, float a_1, float a_2, float b_0, float b_1, float b_2, float *out_8800465547854922746) {
   const float x0 = a_0 - b_0;
   const float x1 = a_1 - b_1;
   const float x2 = a_2 - b_2;
   const float x3 = pow(pow(x0, 2) + pow(x1, 2) + pow(x2, 2), -1.0/2.0);
