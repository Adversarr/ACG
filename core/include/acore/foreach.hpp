...
template <typename A, typename F> void for_each_indexed(const A& access, F&& function);
template <typename A, typename F> void for_each_indexed(A&& access, F&& function);
...
template <typename A, typename F> void transform_indexed(A& access, F&& function);
template <typename A, typename F> void transform_indexed(const A& access, F&& function);
